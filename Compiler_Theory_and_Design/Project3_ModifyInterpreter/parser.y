...
/* Name: Allison McDonald
   ...
   Code was modified to include the additional computations for
   Real & Boolean literals, All additional arithmetic operators,
   All additional relational and logical operators, if and case statements,
   functions with multiple variables, and functions with parameters.
